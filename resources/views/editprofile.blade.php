                    ...
                    <div class="mt-3">
                        <div class="row">
                            ...
                            <div class="col-sm-12 text-secondary">
                                <input type="text" class="form-control" name="username" value="{{ auth()->user()->username }}" id="">
                            </div>
                        </div>
                    </div>
                  </div>
              ...
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                        <input type="text" class="form-control" name="profession" value="{{ auth()->user()->profession }}" id="">
                    </div>
                  </div>
                  <hr>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <input type="text" class="form-control" name="address" value="{{ auth()->user()->address }}" id="">
                    </div>
                  </div>
                  <hr>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <input type="text" class="form-control" name="age" value="{{ auth()->user()->age }}" id="">
                    </div>
                  </div>
                  <hr>
